...
#
def training(model, # a model that is suitable for the dataset provided, its forward receives 1 argument (the batch) and is supposed to get a batch and do all work
             criterion, # loss function
             optimizer, # an optimizer
             dataset, # the data set (suitable for the model)
             ...
             test_set=None, # an optional test set, that is supposed to be independent from dataset
             ...
             balance_test_set=True, # same as above but for the test set
