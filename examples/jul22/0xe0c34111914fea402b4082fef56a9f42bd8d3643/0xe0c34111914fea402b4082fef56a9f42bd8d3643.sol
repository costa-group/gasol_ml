...
contract SpacedSuits is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 3000;
    uint256 public MAX_MINTS = 250;
    string public baseURI = "https://ipfs.io/ipfs/bafybeicczm2exre7qf6fsl7dga5pvu4dkba5kuekruey3ydabzxwdw7rq4/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("Spaced Suits", "SPST", MAX_MINTS, MAX_SUPPLY) {  
