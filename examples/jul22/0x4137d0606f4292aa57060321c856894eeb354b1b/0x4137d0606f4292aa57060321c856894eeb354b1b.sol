...
contract BlockchainHomes is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "https://gateway.pinata.cloud/ipfs/QmbYJYHAhSmkXF7H6CtpFp6tQbTnbwZpgJibz4kBJXH188";
    ...
    constructor(
    ) ERC721A("Blockchain Homes", "Homes", 100, maxSupply) {
    }
