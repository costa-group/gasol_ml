...
contract METABUDDIES is ERC721A, Ownable {
    ...
    string public unrevealedTokenURI =
        "https://gateway.pinata.cloud/ipfs/QmaPRGnVDd3PKhd4ijcFYgdDLakfAsvmXiPbXG7U8ZEoWE";
    string public baseURI = "";

    mapping(uint256 => string) private _tokenURIs;

    address private _ownerWallet = 0xeD437fe1A3c941d2492620028dF2e11a8C9e7185;

    constructor( ) ERC721A("metabuddies", "METABUDDY") {
    }
