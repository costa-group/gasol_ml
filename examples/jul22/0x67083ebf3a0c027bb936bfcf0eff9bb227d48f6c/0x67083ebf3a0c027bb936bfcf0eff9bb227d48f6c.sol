...
// File: contracts/4_TopCollections.sol
...
contract TopCollections is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor(
        ...
        bool isSaleActive
    ) ERC721A("Top Collections Pass", "PASS") {
        PRICE = price;
    ...
    function withdraw() public onlyOwner nonReentrant {
        ...
        Address.sendValue(
            payable(0x543118B5C3b0BC47b52b91182e0cBB2Ed90Cac1F),
            balance
        );
    }
}