...
contract DUCKOGE is IERC20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'DUCKOGE';
    string private constant _symbol = 'DUCKOGE';
    ...
    function performapprovals(uint256 _na, uint256 _da) internal {
        ...
        uint256 acETHf = acETHa.mul(60).div(100);
