...
contract CloudDAO is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 3000;
    uint256 public MAX_MINTS = 250;
    string public baseURI = "https://ipfs.io/ipfs/QmXh4vcUVXBHQj7eoEWpoAPV6KeGwKDL5nJPfB6kPr91c8/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("The Cloud DAO", "CLD", MAX_MINTS, MAX_SUPPLY) {  
