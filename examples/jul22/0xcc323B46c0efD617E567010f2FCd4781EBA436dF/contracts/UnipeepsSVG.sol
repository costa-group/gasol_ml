...
contract UnipeepsSVG {
    ...
    function svgString(
        ...
        return
            abi.encodePacked(
                '<svg version="1.1" width="375" height="636" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 250 424" font-family="\'Inter\', sans-serif"><style>import url(\'https://fonts.googleapis.com/css2?family=Inter:wght100;300;500\');</style><defs><mask id="card"><rect width="100%" height="100%" fill="white" rx="4"/></mask><mask id="firstName"><text fill="white" x="16" y="330" font-size="36" font-weight="100" text-anchor="start">',
                peep.first,
