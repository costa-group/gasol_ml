...
contract BlockAIArt is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    string public baseURI;
    uint256 public cost = 0.002 ether;
    uint256 public maxSupply = 754;
    ...
    constructor() ERC721A("BlockAIArt", "BAA") {
        setBaseURI("");
    ...
    function mintFree(uint256 _mintAmount) public payable nonReentrant{
        ...
        require(addressFreeMintedCount + _mintAmount <= maxperAddressFreeLimit, "Max BlockAIArt per address exceeded");
		require(_mintAmount > 0, "Cant mint 0 BlockAIArt" );
		require(s + _mintAmount <= maxFree, "Can't exceed BlockAIArt supply" );
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Can't mint 0 BlockAIArt");
        require(_mintAmount <= maxperAddressPublicMint, "Can't mint more BlockAIArt" );
        require(s + _mintAmount <= maxSupply, "Can't exceed BlockAIArt supply");
