...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _baseURI() internal view virtual returns (string memory) {
        return "https://bafybeia3wyn3bs6mfszn4xpbwmpyqffkoqjcrcrmwasdrs7q6vdrljoh6m.ipfs.nftstorage.link/";
    }
...
contract NFT is ERC721("Who is the murderer", "WTM"), ERC721Enumerable, Ownable {
    ...
    */
        ...
        payable
    {
        ...
        require(balanceOf(msg.sender).add(_numOfTokens) <= BUY_LIMIT_PER_TX, "Cannot mint above limit");
