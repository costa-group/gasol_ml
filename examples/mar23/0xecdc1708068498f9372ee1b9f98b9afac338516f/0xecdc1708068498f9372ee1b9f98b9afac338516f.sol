 ...
 */
 contract Soulbound is ERC20, Ownable {
    ...
    uint256 public taxForMarketing = 18; //reduced to 0 after launch
    uint256 public maxTxAmount = 20000000 * 10**9;
    uint256 public maxWalletAmount = 20000000 * 10**9;
    address public marketingWallet = 0xc9418eea55121c132e14419B8129aedC1bD24D5B;
    // TOKENOMICS END ============================================================>
    ...
    uint256 private _numTokensSellToAddToLiquidity = 5000000 * 10**9;
    uint256 private _numTokensSellToAddToETH = 2000000 * 10**9;
