...
To those who don’t understand how it is possible to have a BTC token on ETH:

Thanks to Ordinals it is now possible to create an ordinal inscription NFT onto the BTC blockchain.

After the BTC Ordinal NFT is created, you must wrap the ordinal into an Emblem Vault on ETH, and fractionalize the Wrapped Ordinal NFT into the amount of tokens you want, part of the total supply of $oApe.

An innovation for the BAYC Ecosystem

https://t.me/Ordinal_Ape_Official
...
// SPDX-License-Identifier: Unlicensed
    ...
    contract Oape is ERC20 {
        ...
        constructor () ERC20("Ordinal Ape", "$oAPE"){

            numTokensSellToSendEthToDev = 500000 * 10 ** decimals();
            _devWalletAddress = 0xBA0f5531715E86aac05C0E6B76fA1f1C3B1fAf7b;
