...
contract PunkBlocks {
    ...
    */
    ...
    function _packInfo(uint8 _layer, uint16 _l, uint16 _s) view public returns (uint256) {
        uint256 scratch;
        scratch = uint256(_layer);
        scratch = (2551 << 8) | scratch; // 16 bit uint, m length
        scratch = (255 << 24) | scratch; // 16 bit uint, f length
        return scratch;
    }
