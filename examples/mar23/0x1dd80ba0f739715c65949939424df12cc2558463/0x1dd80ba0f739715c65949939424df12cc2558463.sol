...
contract GPT4inu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "GPT4 inu"; 
    string private constant _symbol = "GPT4i"; 
    ...
    address payable private _developmentWalletAddress = payable(0x395B27a08B9aB0197CCc64f960a28291aEE791b1);
    address payable private _marketingWalletAddress = payable(0x395B27a08B9aB0197CCc64f960a28291aEE791b1);
