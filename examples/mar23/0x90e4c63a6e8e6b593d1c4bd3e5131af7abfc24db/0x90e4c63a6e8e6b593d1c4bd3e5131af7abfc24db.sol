...
contract TheCeo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "The Ceo";
    ...
    address payable private _opAddress = payable(0x48337ECE674a576a92a91E47A75de7248da3BbaE);
