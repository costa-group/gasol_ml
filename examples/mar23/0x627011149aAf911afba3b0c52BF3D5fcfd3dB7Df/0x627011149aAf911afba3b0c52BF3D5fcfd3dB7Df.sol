...
http://houichi.rf.gd
Telegram:
https://t.me/HouichiARB
Twitter:
https://twitter.com/HouichiARB
Medium:
https://medium.com/@HouichiARB
*/
 ...
 */
contract Houichi is ERC20, ServicePayer, GeneratorCopyright {
    constructor(
        string memory name_,
        string memory symbol_,
        bytes memory signature_,
        address payable feeReceiver_
    ) payable ERC20(name_, symbol_) ServicePayer(feeReceiver_, "Houichi", signature_, _msgSender()) {
