...
contract TitleProtocol is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountSell = 50_000_000 * 10**_decimals; // 0.5% of supply
    ...
    string private constant _name = "Title Protocol";
    string private constant _symbol = "TITLE";
