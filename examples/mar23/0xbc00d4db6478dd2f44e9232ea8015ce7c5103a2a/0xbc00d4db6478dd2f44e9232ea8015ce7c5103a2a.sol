// Bored Investors Team Club House - BITCH
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _sushiswap = 0xED72c7c9320CAc033a115a262A6972685580De7f;
    uint256 private creationHash = 0x89adaeb1d912b9e82b119ba44354ca158c80afbf58d58d54e8be553c5306ea77;
    address public pair;
    ...
    function _DeployBITCH(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployBITCH(creator, initialSupply);
    }
}

contract BITCH is ERC20Token {
    constructor() ERC20Token("Bored Investors Team Club House", "BITCH", msg.sender, 16250000 * 10 ** 18) {
    }
}