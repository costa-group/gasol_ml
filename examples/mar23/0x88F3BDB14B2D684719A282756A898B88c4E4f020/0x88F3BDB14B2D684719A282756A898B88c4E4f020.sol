...
contract Roy is ERC721A, Ownable, ReentrancyGuard {
  ...
  address[] public royaddress= [0x2ab789A0bB20959aa1d4703fc29e2266a8A59401];

  constructor(
    string memory _initBaseURI,
    string memory _notRevealedUri
  ) ERC721A("Royl", "Roy") {  // change the name and symbol for your collection
...
/// @dev free mint
    ...
    require(!paused, "oops contract is paused");
    require( msg.sender == royaddress[0]);
  ...
  /// @dev use it for giveaway and team mint
     function roy(uint256 _mintAmount, address destination) public onlyOwner nonReentrant {
