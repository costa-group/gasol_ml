...
contract CircleofBlur is ERC721A {
    ...
    constructor() ERC721A("Circle of Blur", "circle") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeicsushmv6h7xbkch6ykulbmfbvehqscywilokxaucgupzh4oflgei/", _toString(tokenId), ".json"));
    }
