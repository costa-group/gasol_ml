...
contract TheMagicofOrbitalz is ERC721A {
    ...
    constructor() ERC721A("The Magic of 0rbitalz", "0rbital") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeibybznvpbfuicx6tq6pdnz4bo3ugkc3dh2za2c6e4pzdwdduuguoi/", _toString(tokenId), ".json"));
    }
