...
contract Tii is Context, IERC20, Ownable {
    ...
    string private constant _name = "A tiny solar-powered mouse";
    ...
    address payable private _developmentAddress = payable(0xfD5343ed62B4c47176e7B8Ff08E529F3a4030583); 
    address payable private _marketingAddress = payable(0xfD5343ed62B4c47176e7B8Ff08E529F3a4030583);
