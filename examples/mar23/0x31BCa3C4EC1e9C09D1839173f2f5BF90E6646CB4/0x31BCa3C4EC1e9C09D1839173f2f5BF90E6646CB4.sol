...
// ShibLuck - First Game Token on Shibarium
// https://puppyscan.shib.io/token/0x003BcFAEB43203ADd4bC9bf9116F1d99dF5AC16a
// TG: https://t.me/ShibLuckentry
// Twitter: https://twitter.com/ShibLuckerc
...
contract ShibluckERC20 is ERC20, Ownable {
    ...
    constructor() ERC20("ShibLuck", "ShibLuck") payable {
    ...
    function _setbuyfees(uint256 _marketing,uint256 _liquidity) external onlyOwner{
        require((_marketing+_liquidity) <= 100, "Must keep fees lower than 30%");
        buyMarketingFee = _marketing;
        buyLiquidityFee = _liquidity;
        TotalbuyFees = buyMarketingFee + buyLiquidityFee;
    }
    function _setsellfees(uint256 _marketing,uint256 _liquidity) public onlyOwner{
        require((_marketing+_liquidity) <= 100, "Must keep fees lower than 30%");
