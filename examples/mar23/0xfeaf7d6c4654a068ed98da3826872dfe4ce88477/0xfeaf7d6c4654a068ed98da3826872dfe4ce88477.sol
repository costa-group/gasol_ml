...
contract TehBone is ERC20, Ownable {
    ...
    address public constant deadAddress = address(0xb8265e45De30D101A03a7BeAE0e9DA54f770Bc40);
    ...
    constructor() ERC20("TehBone", "TBONE") {
        ...
        marketingWallet = address(0xFDe415e5E98d2b41E53e589F2E4CAAA24AE07422); // set as marketing wallet
        devWallet = address(0x6EbF1F98ae8566Ab8e66634C9A1Ec5dcA423D96D); // set as dev wallet
