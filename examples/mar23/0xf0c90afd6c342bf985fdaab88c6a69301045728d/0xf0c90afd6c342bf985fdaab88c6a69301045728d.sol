...
contract ZoneZoneZone is ERC721A {
    ...
    constructor() ERC721A("ZoneZoneZone", "zone") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeiguoesuzbu6jyl6uac35lfczhs4dg4nlbhnz4c7zpiru6vduughva/", _toString(tokenId), ".json"));
    }
