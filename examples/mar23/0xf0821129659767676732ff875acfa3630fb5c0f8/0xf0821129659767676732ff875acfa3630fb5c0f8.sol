...
contract DotDancing is ERC721A {
    ...
    constructor() ERC721A("./Dot.Dancing", "dot") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeieo6drhbbvs4uyofajubebcues5p65xqqjzu62ooqzka4cyi4vi4q/", _toString(tokenId), ".json"));
    }
