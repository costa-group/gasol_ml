...
contract MilkChef is Ownable, ReentrancyGuard {
    ...
    // Compound ratio which is 0.0015% (will be used to decrease supply)
    uint256 public compoundRatio = 15e12;
