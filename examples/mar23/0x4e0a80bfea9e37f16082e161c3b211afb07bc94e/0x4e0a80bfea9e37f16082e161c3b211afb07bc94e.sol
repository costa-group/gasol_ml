...
contract KOARA is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x600f31E5496226a31d176B456C2B6385555D3466); 
    address payable private _marketingAddress = payable(0x05284a96d0edb8bb149218eCC47d8C857A2009EC);
