...
contract CamKingToken is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xcbB713653e6a1B8c7735850ac0b36fF49DcbE2E4); // Marketing Address
    address payable public devAddress = payable(0x6E833b4eCC63FC17A0fB5573d8F2E21bd3db8560); // Dev Address
