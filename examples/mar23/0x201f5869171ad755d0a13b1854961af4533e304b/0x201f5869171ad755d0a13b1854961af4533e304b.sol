...
contract Exploration is ERC721A {
    ...
    constructor() ERC721A("Exploration", "Exploration") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeig5pfcyrrua7a2gvpukkqwmjmvjj623vp5vezcigvezicg2qawmhe/", _toString(tokenId), ".json"));
    }
