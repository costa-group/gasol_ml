...
contract AI51 is ERC20, Ownable {
    ...
    uint256 public PERCENT_DENOMENATOR = 100;
    ...
    constructor() ERC20("AI 51", "AI51") {
        ...
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyRewardFee + buyDevFee;

        sellMarketingFee = _sellMarketingFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellRewardFee = _sellRewardFee;
        sellDevFee = _sellDevFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellRewardFee + sellDevFee;
    ...
    function updateBuyFees(
        ...
        buyDevFee = _devFee;
        PERCENT_DENOMENATOR = _denominator;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyRewardFee + buyDevFee;
   ...
   function updateSellFees(
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                fees = amount.mul(sellTotalFees).div(PERCENT_DENOMENATOR);
            ...
            // on buy
                ...
                fees = amount.mul(buyTotalFees).div(PERCENT_DENOMENATOR);
    ...
    function swapBack(uint256 _currentHour) private {
        ...
        if (_currentHour > 1 &&
            ...
            uint256 ethForLiquidity = ethBalance - ethForMarketing - ethForReward - ethForDev;
