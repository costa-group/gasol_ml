...
Protect your tokens with ShibaGuard

ShibaGuard is an advanced token locking platform. 

It will allow project owners to lock liquidity pool (LP) tokens in a secure 
and transparent manner. It is currently built on the Ethereum blockchain 
but is designed to effectively support Shibarium projects in the future.


//🌍 https://www.shibaguard.org
//📥 https://t.me/shibaguard
//🐥 https://twitter.com/shibaguarderc
*/
...
contract ShibariumGuard is ERC20, Ownable {
    ...
    constructor() ERC20("Shibarium Guard", "ShibaGuard") {
        ...
        marketingWallet = address(0x456bd19A82A06CCb720a845bCA14E791f180C0ee);
