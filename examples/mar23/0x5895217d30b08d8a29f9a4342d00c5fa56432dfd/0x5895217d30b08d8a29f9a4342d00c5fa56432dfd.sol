...
contract TheArk is IERC20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        // Set fee receivers
        liquidityWallet = 0x988F82C9ecDc2C2aC45607208D0238fC21B74EB6;
        marketingWallet = 0x988F82C9ecDc2C2aC45607208D0238fC21B74EB6;
        developmentWallet = 0x988F82C9ecDc2C2aC45607208D0238fC21B74EB6;
    ...
    function startTrading() external onlyOwner {
        ...
        tradeBlock = false;
        sniperTaxTill = block.number + 3; // (<sniperTaxTill, so first block)
        lockUsed = true;
    }
