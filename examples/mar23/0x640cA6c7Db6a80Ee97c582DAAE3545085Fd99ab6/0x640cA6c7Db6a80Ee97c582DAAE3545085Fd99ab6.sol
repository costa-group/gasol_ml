...
contract WillySlapper is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    uint256 public max_per_wallet = 999999;    
    uint256 public max_per_txn = 30;    
    uint256 public MAX_SUPPLY = 5000;    

    constructor(string memory _initBaseURI, string memory _initNotRevealedUri, string memory _contractURI) ERC721A("Willy Slapper", "WS") {
