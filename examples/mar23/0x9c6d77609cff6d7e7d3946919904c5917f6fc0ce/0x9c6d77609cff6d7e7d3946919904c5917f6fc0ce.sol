...
contract ShibariumPunk is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shibarium Punk", "SHIPUNK") {
        ...
        marketingWallet = address(0x429791B73F9cBf2d4A1b25FF6623A0324C705B09);
        developmentWallet = address(0x429791B73F9cBf2d4A1b25FF6623A0324C705B09);
