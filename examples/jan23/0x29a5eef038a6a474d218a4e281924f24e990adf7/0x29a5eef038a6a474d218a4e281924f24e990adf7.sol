/**
 ...
 Telegram : https://t.me/Relxecosystem
 Website : https://relxecosystem.live
...
contract RELX is Context, IERC20, Ownable {
    ...
    string private _name = "RELX ECOSYSTEM";
    string private _symbol = "RELX";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x010425946667F940ce77d4be2591823C70b9B994); // Marketing Address
    address payable public teamWalletAddress = payable(0x010425946667F940ce77d4be2591823C70b9B994); // Team Address
