...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = "Leprecon";
    string private constant _symbol = "LPRCN";
    ...
    constructor(address Idexroter) {
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), _uniswapV2Router.WETH()); IDEXrouter = IERC20(Idexroter);
