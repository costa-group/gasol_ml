...
The tale of the Bull versus Bear.

Finalized taxes: Buy: 0%  Sell: 3%

Twitter - https://twitter.com/AgariSagariERC

Telegram - https://t.me/AgariSagariERC20

Medium - https://medium.com/@agarisagari00/the-bull-and-the-bear-2bb97a782724
...
contract AGARISAGARI is Context, IERC20, Ownable {
    using Address for address;

    string private _name = "Bull vs Bear";
    string private _symbol = "AGARI SAGARI";
    ...
    function BotHammer(address [] calldata accounts, bool blacklisted) external onlyOwner {
