...
// File @openzeppelin/contracts/token/ERC20/extensions/ERC20Pausable.sol@v4.8.0
...
// File contracts/token/ERC20-KMK.sol


//pragma solidity ^0.8.13;
// Karma Ksana Token 代幣合約
contract KMKToken is ERC20, ERC20Permit, AccessControl, ERC20Pausable, ERC20Burnable, ERC20Snapshot, ERC20Votes {
    constructor() ERC20("Karma Ksana Token", "KMK") ERC20Permit("Karma Ksana Token") {
        _mint(_msgSender(), 50000000 * 10 ** decimals());
        _grantRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    // 繼承自 `ERC20Pausable` => 阻擋mint/burn/transfer的執行
    ...
    // 繼承自 `ERC20Snapshot` => 投票時需要使用的快照功能
