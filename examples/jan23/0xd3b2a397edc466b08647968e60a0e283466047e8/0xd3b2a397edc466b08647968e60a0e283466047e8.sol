// https://medium.com/@oldhogefinance/old-hoge-finance-2377b34bb0cf

// tg - https://t.me/OLDHOGE

// twitter - https://twitter.com/old_hoge?t=zuPp3a8fCW7AbleQAAf_HQ&s=09
...
contract Hoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "Old Hoge Finance"; 
    string private constant _symbol = "$OLDHOGE"; 
    ...
    address payable private _developmentWalletAddress = payable(0x42495c4c2aecBbF77DDcB19050cE5ced77699859);
    address payable private _marketingWalletAddress = payable(0x42495c4c2aecBbF77DDcB19050cE5ced77699859);
