...
contract HIKO is ERC20, Ownable {
    ...
    constructor() ERC20("Sachiko", "HIKO") {
        ...
        marketingWallet = address(0xbAAf3e2FDc6a78F9c7789d29640AAaE903FDF0D2); // set as marketing wallet
        devWallet = address(0xbAAf3e2FDc6a78F9c7789d29640AAaE903FDF0D2); // set as dev wallet
