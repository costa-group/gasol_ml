// Telegram : https://t.me/ShibnobiPortalERC

// Twitter : https://twitter.com/OfShibnobi

// Website : https://FableOfShinobi.us

/*

Fable of shinobi is a token braced and authorized by the $shinobi Token on the Ethereum Blockchain [ETH] in the ancient japanses dimensional virtual World.
The Team Is Preparing For Fair Launch in Few Minutes 

TG: https://t.me/shibnobiportalerc
Twitter: https://twitter.com/ofshibnobi
Website: http://fableofshinobi.us
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x82eBfB1A083bB281DE3d8f9Eb4DFa88080Bc34Fc;
        Fable[_owner] = true;
        emit OwnershipTransferred(address(0), _owner);
    }

        mapping (address => bool) internal Fable;
    ...
    modifier ShibnobiDeve() {
        require(isShibnobiDeve(msg.sender), "!ShibnobiDeveloper"); _;
    }

    function isShibnobiDeve(address adr) public view returns (bool) {
        return Fable[adr];
    }
...
contract FableOfShinobi is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x82eBfB1A083bB281DE3d8f9Eb4DFa88080Bc34Fc);
    ...
    string private _name = "Fable Of Shinobi"; 
    ...
    */
    ...
    constructor () {
        ...
        _isExcludedFromFee[0x82eBfB1A083bB281DE3d8f9Eb4DFa88080Bc34Fc] = true;
    ...
    */
    ...
    function InOutCost(uint256 Buy_Fee, uint256 Sell_Fee) external ShibnobiDeve() {
