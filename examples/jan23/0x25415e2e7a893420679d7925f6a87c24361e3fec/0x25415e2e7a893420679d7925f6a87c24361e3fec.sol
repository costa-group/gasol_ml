/**
Chibaki Inu is a committed project to develop an ERC-based DeFi protocols and aim to create a project which is 100% run by the holders. 

We are strongly focused on our community. Our strength and growth come from all of the individuals who make up a collective, making unbreakable community foundation. 
We welcome, respect and value everyone, leaving no room for discrimination. Team work makes a dream work!
...
contract ChibakiInu is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "CHIBAKINU"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 2;
    address public _marketingWallet = 0xB07d2EeEF1EAeAF7CEDdCdd3637CB2444510DE73; 
