...
contract SolanaClassicCoin is ERC20, Ownable {
    ...
    constructor() ERC20("Solana Classic Coin", "SCC") {
        ...
        devWallet = address(0xeC6D98C616cbF04895f891395C83e2Db7Bae289b); // set as dev wallet
