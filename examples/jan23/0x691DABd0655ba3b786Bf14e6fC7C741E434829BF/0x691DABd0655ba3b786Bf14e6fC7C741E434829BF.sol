...
Cheems 2023 is an ERC20 token project inspired by the latest Cheems project, and 2023 extends name tokens. We're here to extend the hype of the new year's token as of now. Let's start the year with happiness and joy in our faces, so buckle up and get ready to launch and witness the token that can break all the current records now.
...
contract Cheems2023  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x62bb1636CB4Ca96d0E7950720378fA90a986Cf49); 
    address payable public Wallet_Dev = payable(0x62bb1636CB4Ca96d0E7950720378fA90a986Cf49);
    ...
    string private constant _name = "Cheems2023"; 
    string private constant _symbol = unicode"Cheems2023"; 
    ...
    constructor () {
        ...
        _owner = 0x62bb1636CB4Ca96d0E7950720378fA90a986Cf49;
