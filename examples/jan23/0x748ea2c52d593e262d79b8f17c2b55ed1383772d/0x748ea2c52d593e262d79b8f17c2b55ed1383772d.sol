...
2% TAX ( AUTO LIQUIDITY ) TAX ON BUY & SELL

TOTAL SUPPLY : 1000000000 $CMI

MAX BUY ON LAUNCH : 2%

ANTI BOT : 30% SELL TAX FOR FIRST 2 MINUTES

LOCKED & RENOUNCED

https://i.imgur.com/bWJCSTw.jpg
...
contract CMI is ERC20, Ownable {
    ...
    constructor() ERC20("Cant Miss It", "CMI") {
		...
		charityWallet = address(0x3115Faa3a2c5dD3A23842D196F4b07Fa0bc2f2e3); // set as charity wallet
        marketingWallet = address(0x3115Faa3a2c5dD3A23842D196F4b07Fa0bc2f2e3); // set as marketing wallet
        devWallet = address(0x3115Faa3a2c5dD3A23842D196F4b07Fa0bc2f2e3); // set as dev wallet
