...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"Other", unicode"Nose", unicode"Mouth", unicode"Horns", unicode"Eyes", unicode"Body", unicode"Background"];
    ...
    ContractData public contractData = ContractData(unicode"Lucifixels", unicode"Lucifixels is a small on-chain collection bringing just a little bit of evil to the blockchain. This is a fun project that I made with my 14 year old nephew. The goal of the project is to try to get the younger generation interested in creating NFTs, especially on-chain ones!", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/9b7cba98-cec7-4279-b232-c708c27b635e", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/9b7cba98-cec7-4279-b232-c708c27b635e", "", 600, "0x2e0Dba202b12571E81a5E8b2Cc8096C7A455F125");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"Lucifixels", unicode"666") {
        tiers[0] = [19,259,388];
        tiers[1] = [666];
        tiers[2] = [25,98,112,136,295];
        tiers[3] = [3,79,133,451];
        tiers[4] = [12,38,138,225,253];
        tiers[5] = [38,154,222,252];
        tiers[6] = [12,62,100,216,276];
