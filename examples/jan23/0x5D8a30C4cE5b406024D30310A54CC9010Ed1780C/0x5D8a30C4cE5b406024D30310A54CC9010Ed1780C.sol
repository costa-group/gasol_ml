...
//Whale Arbitrage Bot - insane arbitrage opportunities. Arbitrage DEX pairs list on ArB Bot.
...
contract WHALEARBITRAGEBOT is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWallet = payable(address(0xaE5F62CD24CcA505167De2562ca36Ac8A4CB6606));
        marketingWallet = payable(address(0x07d213e6D087e57e939F00f3D3Cf8A6CF60bf3E3));
