 ...
 * notice This contract handles minting Bored Ape Xmas Party tokens.
 */
contract BoredApeXmasParty is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x2064e634dAC08ffB25Fe80322e87Db2cE3Eded35;
    address public freeClaimContractAddress =
        0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D;
    address public royaltyAddress = 0xc727cf91d09c46f375dd5d529F5E532fcF182db9;
    address[] public payoutAddresses = [
        0xd9B610A083A2Ea239C6b7713f5490234Ec0Ed8e4
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeifc2ypexp4hbtrfjuxvc5m744jd43dnhvi3bmrgpdywcxeoh4gx2i/";
    uint256 private currentLoanIndex = 0;
    // Maximum supply of tokens that can be minted
    uint256 public constant MAX_SUPPLY = 10000;
    // Total number of tokens available for minting in the presale
    uint256 public constant PRESALE_MAX_SUPPLY = 3400;
    ...
    constructor() ERC721A("Bored Ape Xmas Party", "BAXP") {
