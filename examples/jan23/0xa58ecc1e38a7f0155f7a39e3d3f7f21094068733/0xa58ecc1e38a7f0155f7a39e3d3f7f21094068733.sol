...
/**
https://t.me/JubeiKibagamierc
https://medium.com/@jubeikibagamierc/jubei-kibagami-erc-c5c2cf71cef5
*/
...
contract JUBEIKIBAGAMI is ERC20, Ownable {
    ...
    constructor() ERC20("JUBEI KIBAGAMI", "JK") payable {
    	...
    	marketingWallet = address(0x8Ea52CdbE9eDFdc3e4c3AAE58268a716cEbaE461); // set as Marketing wallet
        devWallet = address(0x2BE3eE20E53CEbd53DC32d567efaE71b7036F295); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x8Ea52CdbE9eDFdc3e4c3AAE58268a716cEbaE461, true);
        excludeFromFees(0x2BE3eE20E53CEbd53DC32d567efaE71b7036F295, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x8Ea52CdbE9eDFdc3e4c3AAE58268a716cEbaE461, true);
        excludeFromMaxTransaction(0x2BE3eE20E53CEbd53DC32d567efaE71b7036F295, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x2BE3eE20E53CEbd53DC32d567efaE71b7036F295,
            block.timestamp
        );
    }
