...
contract ERC721AContract is ERC721A, Controllerable {

    address public metadata;
    bool public useMetadata;
    string internal baseTokenURI;

    constructor(address owner_) ERC721A("CensorlessERC721A", "CERC721A") {
    ...
    function controllerBurn(uint256 tokenId_, bool approvalCheck_) external onlyController("BURNER") {
