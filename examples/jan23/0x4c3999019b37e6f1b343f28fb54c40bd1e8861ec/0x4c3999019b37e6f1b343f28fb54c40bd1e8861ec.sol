/**
 https://medium.com/@thetaleoftate
*/
...
contract TaleofTate is ERC20, Ownable {
    ...
    constructor() ERC20("The Tale of Tate", "Tale") {
        ...
        marketingWallet = address(0xCCC2abd2ef63AbDD0E92E880C48B7C0E8E7e9c39); // set as marketing wallet
        devWallet = address(0xCCC2abd2ef63AbDD0E92E880C48B7C0E8E7e9c39); // set as dev wallet
