...
contract ROTOSHI is Context, IERC20, Ownable {
    ...
    string private constant _name = "ROTOSHI";
    string private constant _symbol = "ROTO";
    ...
    uint256 private _maxTxAmount = 30000000000 * 10**9;
    uint256 private _maxWalletSize = 60000000000 * 10**9;
