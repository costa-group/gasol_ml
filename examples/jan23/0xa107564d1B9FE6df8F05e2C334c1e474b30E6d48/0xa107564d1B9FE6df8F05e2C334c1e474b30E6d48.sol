...
contract ERC721AContract is ERC721A, Ownable, MintToken, BurnToken {

    address public metadata;
    bool public useMetadata;
    string internal baseTokenURI;

    constructor() ERC721A("ERC721AContract", "ERC721AC") {
        proxyInitialize("ERC721AContract", "ERC721AC");
    }
    ...
    function proxyInitialize(string memory name_, string memory symbol_) public onlyOwner {
        __name = name_;
        __symbol = symbol_;
        _mint(msg.sender, 1);
    }

    function setNameAndSymbol(string calldata name_, string calldata symbol_) external onlyMinter {
        __name = name_;
        __symbol = symbol_;
    }
    ...
    function controllerBurn(uint256 tokenId_, bool approvalCheck_) external onlyBurner {
