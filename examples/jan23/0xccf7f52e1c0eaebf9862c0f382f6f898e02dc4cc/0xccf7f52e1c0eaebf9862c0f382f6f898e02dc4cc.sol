...
Website http://www.wrappedrabbit.com
...
contract WABBIT is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletToken = _tTotal.div(1000).mul(10);
    ...
    uint256 public _sellmarketdevFee = 20;  
    ...
    uint256 private totalFee = reflectionFee.add(liquidityFee).add(marketdevFee);
    uint256 private currenttotalFee = totalFee;
    
    uint256 public swapThreshold = _tTotal.div(10000).mul(10); 

    bool inSwap;
    bool public tradingOpen = false;

    string private _name = "Wrapped Rabbit";
    string private _symbol = "WABBIT";
   
    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;
    address payable private marketdevWallet = payable (0xbdB8B9C116233eA8b90A3909e364b80107D1DE6d); // Marketing Wallet
    ...
    function setTaxBuy(uint256 _bReflectionFee, uint256 _bLiquidityFee, uint256 _bMarketdevFee) external onlyOwner {
        ...
        totalFee = reflectionFee.add(liquidityFee).add(marketdevFee);
    }
