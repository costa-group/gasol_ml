...
contract GhostlersStaking is Ownable {
    
    mapping(uint => mapping(uint => uint)) public reward;
    function setReward(uint locking_months, uint level, uint BOOCOINS_in_wei) public onlyOwner{
...
////////////////////////////////////////////////////////////////////////////////////////
    ...
    function stake(uint256[] memory ids, bytes32[][] calldata merkleproof, uint[] memory locking_months, uint[] memory levels) public {
...
////////////////////////////////////////////////////////////////////////////////////////
    ...
    constructor() {
        merkleRoot[1] = 0x7bb81aa88595be0ff2df96e4a29faa2c541aaaaeed60e8a15e1ad5406e2d6c6c;
        merkleRoot[2] = 0x84f82b17adbfac8c3b2a0a51276b637652e228c77678383dbf99828c421d735b;
        merkleRoot[3] = 0xab0b230421c8f3fae8713f76c6281b72e276b3d6a791ac8326efa7514e42d44b;
        merkleRoot[4] = 0x91ea53917b70190d3fa658e0f8fa0d13d92473a33f3f23bdb3ae654772bc8ae1;
        merkleRoot[5] = 0xa328d2c1384b0c3eff25881a408e984ec137a38318a78b4804ef87f5ddcd4570;
        merkleRoot[6] = 0x69a688ee4a19248399a1ed719b7b7809e003857f1292f1ad6f2513d6f67341a1;

        setReward(1, 1, 150000000000000000000);
        setReward(1, 2, 270000000000000000000);
        setReward(1, 3, 360000000000000000000);
        setReward(1, 4, 450000000000000000000);
        setReward(1, 5, 660000000000000000000);
        setReward(1, 6, 990000000000000000000);

        setReward(3, 1, 720000000000000000000);
        setReward(3, 2, 1080000000000000000000);
        setReward(3, 3, 1350000000000000000000);
        setReward(3, 4, 1620000000000000000000);
        setReward(3, 5, 2250000000000000000000);
        setReward(3, 6, 3240000000000000000000);

        setReward(6, 1, 1980000000000000000000);
        setReward(6, 2, 2700000000000000000000);
        setReward(6, 3, 3240000000000000000000);
        setReward(6, 4, 3780000000000000000000);
        setReward(6, 5, 5040000000000000000000);
        setReward(6, 6, 7020000000000000000000);

        setReward(12, 1, 5040000000000000000000);
        setReward(12, 2, 6480000000000000000000);
        setReward(12, 3, 7560000000000000000000);
        setReward(12, 4, 8640000000000000000000);
        setReward(12, 5, 11160000000000000000000);
        setReward(12, 6, 15120000000000000000000);
    }
}