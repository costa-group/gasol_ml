...
contract NIFTY is ERC20, Ownable {
    ...
    constructor() ERC20("NIFTY Official", "NIFTY") {
        ...
        uint256 totalSupply = 6_000_000_000 * 1e18; // 6 billion total supply

        maxTransactionAmount = 30_000_000 * 1e18; // .5% from total supply
        maxWallet = 60_000_000 * 1e18; // 1% from total supply maxWallet
        ...
        devWallet = address(0xe5cEfAe8bF0275373fab3cD51FD42F0c56856C21); // set as dev wallet
