/*
After CZ decides to purchase FTX on the cheap, FTX2.0 will be there to takeover.
...
contract FTX2 is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0x3Ce4e256c714f8A5E59c6e04585FBF5Bd3bc8abe);
    ...
    constructor() ERC20("FTX 2.0", "F2X") {
        ...
        marketingWallet = address(0x52291B85f8fC1c95dd9a9b3205817613CFB50c47); // set as marketing wallet
