 ...
 * allowances. See {IERC20-approve}.
 */
contract FBC is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Future Bitcoin";
    ...
    uint256 public maxTxAmount = 1500 * 10**_decimals;
    uint256 public maxWalletAmount = 1500 * 10**_decimals;
    address public marketingWallet = 0xd7b4a5DbBC79fF647c9c1C899C79293C647a7E5B;
    // TOKENOMICS END ============================================================>
