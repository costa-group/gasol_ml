...
contract WATERRABBIT is ERC20, Ownable {
    ...
    constructor() ERC20("Year of The Water Rabbit", "WRABBIT") {
		...
		charityWallet = address(0x639A8e0C2926420068F9654DD146981291915963); // set as charity wallet
        marketingWallet = address(0x639A8e0C2926420068F9654DD146981291915963); // set as marketing wallet
        devWallet = address(0x639A8e0C2926420068F9654DD146981291915963); // set as dev wallet
