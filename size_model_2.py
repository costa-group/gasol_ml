from datasets import GasolBytecodeSeq, SequenceBuilder_1, class_generator_4_size
...
def train(epochs=171):
    dataset = GasolBytecodeSeq(root='data', name='size_gas', tag='size_model_2', sequence_builder=SequenceBuilder_1(class_gen=class_generator_4_size))
    model_args = {
        "hidden_channels": 64,
