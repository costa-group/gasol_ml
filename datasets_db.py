...
dataset_db[12] = lambda tag: GraphBasedBasicBlocksDataset(root='data',
                                                            name='jul22-0xABC-8-17',
                                                            tag=tag,
                                                            graph_builder=BytecodeSequenceGraph(label_f=block_label_size_saved,node_features='multi_push'),
                                                            basic_block_filter=MinSizeOfInputBlockFilter(1)
...
dataset_db[13] = lambda tag: GraphBasedBasicBlocksDataset(root='data',
                                                            name='jul22-0xb-8.17',
                                                            tag=tag,
                                                            graph_builder=BytecodeSequenceGraph(label_f=block_label_size_saved,node_features='multi_push'),
                                                            basic_block_filter=MinSizeOfInputBlockFilter(1)
...
dataset_db[14] = lambda tag: GraphBasedBasicBlocksDataset(root='data',
                                                            name='jul22-0xd-8.17',
                                                            tag=tag,
                                                            graph_builder=BytecodeSequenceGraph(label_f=block_label_size_saved,node_features='multi_push'),
                                                            basic_block_filter=MinSizeOfInputBlockFilter(1)
