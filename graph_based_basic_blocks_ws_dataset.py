...
# and their classes
#
class GraphBasedBasicBlocksWSDataset(InMemoryDataset):
    ...
    def __init__(self, root, zips, tag, graph_builder,basic_block_filter=AlwaysTrueFilter()):
        ...
        super().__init__(root)
        self.data, self.slices, self.vocab_size = torch.load(self.processed_paths[0])
    ...
    def process(self):
        ...
        torch.save((data, slices, vocab_size), self.processed_paths[0])
